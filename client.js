...
},{"buffer":45,"isarray":35}],35:[function(require,module,exports){
...
},{"buffer":45,"isarray":42}],40:[function(require,module,exports){
(function (global,Buffer){
...
},{"./binary":39,"buffer":45,"debug":10,"emitter":41,"isarray":42,"json3":43}],41:[function(require,module,exports){
...
exports.cue = require('../cue.js')();


// var share = require('share');
// var share = new sharejs.Connection(ws);

exports.io = require('socket.io-client', {expose: 'io'});

// var Symphony = exports.SymphonyClient = function (host)
// {
// 	this.host = host;
// 	cueHandlers = {};
...
// 	    newCue = new Cue(JSON.parse(data));
// 	}catch(e){console.log(e.stack);console.log("broken cue?", newCue);}
// 	    type = newCue.type;
// 	    console.log(type);
// 	    if(type && type in cueHandlers)
// 	    {
...
},{"../cue.js":1,"socket.io-client":2}]},{},[49])(49)
});